...
public enum CommonErrorCodes {
    ...
    AUTHENTICATION_ERROR(
            "AUTHENTICATION_ERROR", "Authentication error", HttpStatus.UNAUTHORIZED
    ),
    NO_HANDLER_FOUND(
            "NO_HANDLER_FOUND", "No endpoint GET URL", HttpStatus.NOT_FOUND
    ),
    UNKNOWN(
    ...
    ILLEGAL_STATE(
            "ILLEGAL_STATE", "Illegal state", HttpStatus.BAD_REQUEST
    );
